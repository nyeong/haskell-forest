...
nix --accept-flake-config run github:juspay/omnix -- \
  init github:srid/haskell-forest -o ./yourproject
```
...
Full instructions: https://srid.ca/haskell-forest/start
...
- Run the application without installing: `nix run github:srid/haskell-forest` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://community.flake.parts/haskell-flake/dependency
  - Adding tests: https://srid.ca/haskell-forest/tests

## Discussions

Questions? Ideas? Suggestions? Join our [NixOS Zulip](https://nixos.zulipchat.com/#narrow/stream/413949-haskell-flake) or post in [Github Discussions](https://github.com/srid/haskell-forest/discussions).
